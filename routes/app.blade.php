...
<head>
    ...
    <!-- radial chart.css -->
    <link rel="stylesheet" href="{{URL::asset('files\assets\pages\chart\radial\css\radial.css')}}" type="text/css"
        media="all">
    <!-- feather Awesome -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('files\assets\icon\feather\css\feather.css')}}">
    {{-- se;ect 2 --}}
    <link rel="stylesheet" type="text/css" href="{{URL::asset('files\bower_components\select2\css\select2.min.css')}}">
    <!-- Style.css -->
    ...
    <link rel="stylesheet" type="text/css"
        href="{{URL::asset('files\assets\pages\advance-elements\css\bootstrap-datetimepicker.css')}}">
    <!-- Date-range picker css  -->
    <link rel="stylesheet" type="text/css"
        href="{{URL::asset('files\bower_components\bootstrap-daterangepicker\css\daterangepicker.css')}}">
    <!-- Date-Dropper css -->
    <link rel="stylesheet" type="text/css"
        href="{{URL::asset('files\bower_components\datedropper\css\datedropper.min.css')}}">
    <link href="{{URL::asset('files\assets\pages\jquery.filer\css\jquery.filer.css')}}" type="text/css"
        rel="stylesheet">
    <link href="{{URL::asset('files\assets\pages\jquery.filer\css\themes\jquery.filer-dragdropbox-theme.css')}}"
    ...
    <link rel="stylesheet" type="text/css"
        href="{{URL::asset('files\bower_components\jquery.steps\css\jquery.steps.css')}}">
                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="https://www.bikaji.com">
                            ...
                            {{-- <img class="img-fluid" src="https://www.bikaji.com/pub/media/logo1.png" alt="Theme-Logo"
                                style="max-width: 67%;"> --}}
                        </a>
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="{{\Storage::disk('public')->url(auth()->user()->profileimage ??'N/A')}}"
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu"
                                        ...
                                        <li>
                                            <a href="{{route('frontofficeprofile')}}">
                                                <i class="feather icon-user"></i> Profile
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{route('frontchangepassword')}}">
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="{{route('customercomplaintslist')}}">
                                        <span class="pcoded-micon"><i class="feather icon-menu"></i></span>
                                        <span class="pcoded-mtext">Customer Complaints</span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class="">
                                            <a href="{{route('frontofficetrackcomplaint')}}">
                                                <span class="pcoded-mtext">Complaint</span>
                                            </a>
                                        </li>
                                        <li class="">
                                            <a href="{{route('frontofficetrackinquiry')}}">
                                                <span class="pcoded-mtext">Inquiry</span>
                                            </a>
                                        </li>
                                    </ul>
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{URL::asset('files\bower_components\bootstrap\js\bootstrap.min.js')}}">
    </script>
    ...
    <script type="text/javascript"
        src="{{URL::asset('files\assets\pages\advance-elements\moment-with-locales.min.js')}}"></script>
    <script type="text/javascript"
        src="{{URL::asset('files\bower_components\bootstrap-datepicker\js\bootstrap-datepicker.min.js')}}"></script>
    <script type="text/javascript"
        src="{{URL::asset('files\assets\pages\advance-elements\bootstrap-datetimepicker.min.js')}}"></script>
    <!-- Date-range picker js -->
    <script type="text/javascript"
        src="{{URL::asset('files\bower_components\bootstrap-daterangepicker\js\daterangepicker.js')}}"></script>
    <!-- Date-dropper js -->
    <script type="text/javascript" src="{{URL::asset('files\bower_components\datedropper\js\datedropper.min.js')}}">
    </script>
    ...
    <script src="{{URL::asset('files\bower_components\datatables.net-responsive\js\dataTables.responsive.min.js')}}">
    </script>
    <script
        src="{{URL::asset('files\bower_components\datatables.net-responsive-bs4\js\responsive.bootstrap4.min.js')}}">
    </script>
    <script type="text/javascript"
        src="{{URL::asset('files\bower_components\bootstrap-maxlength\js\bootstrap-maxlength.js')}}"></script>
    ...
    <!-- Custom js -->
    <script type="text/javascript" src="{{URL::asset('files\assets\pages\advance-elements\custom-picker.js')}}">
    </script>
    ...
    <script>
        ...
        var channel = pusher.subscribe('customercomplaint-create');
        var channel2 = pusher.subscribe('inquiry-created');
        var channel3 = pusher.subscribe('complaint-created');
        var channel4 = pusher.subscribe('complaint-resolved');
        var channel5 = pusher.subscribe('inquiry-resolved');

        // Bind a function to a Event (the full Laravel class)
        channel.bind('customercomplaintcreate', function(data) {
            appendnotification(data);
        });

        channel2.bind('inquirycreate', function(data) {
            appendnotification(data);
        });

        channel3.bind('complaintcreate', function(data) {
            appendnotification(data);
        });

        channel4.bind('complaintresolved', function(data) {
            appendnotification(data);
        });

        channel5.bind('inquiryresolve', function(data) {
            appendnotification(data);
        });
    </script>
