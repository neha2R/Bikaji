                ...
                <div class="col-md-12 wow animated fadeInRight" data-wow-delay=".2s" style="text-align: center">
                    <form class="shake" action="" method="POST" id="contactForm" name="contact-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control" id="name" type="text" name="name" data-error="Please enter your name" minlength="3" maxlength="50" pattern="[a-zA-Z ]*$" value="{{ old('name')}}" oninvalid="setCustomValidity('Please enter on alphabets only. ')">
                            {!! $errors->first('name', '<p style="color: red" class="help-block">:message</p>') !!}
                        </div>
                        <!-- email -->
                        <div class="form-group label-floating">
                            <label class="control-label" for="email">Email</label>
                            <input class="form-control" id="email" type="email" name="email" value="{{ old('email')}}" data-error="Please enter your Email">
                            {!! $errors->first('email', '<p style="color: red" class="help-block">:message</p>') !!}
                        </div>
                        <!-- mobile -->
                        <div class="form-group label-floating">
                            <label class="control-label" for="phone">Mobile Number</label>
                            <input class="form-control" id="phone" type="text" name="mobile" value="{{ old('mobile')}}" data-error="Please enter your Mobile Number">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control" id="pincode" type="text" name="pincode" value="{{ old('pincode')}}" maxlength="6">
                            {!! $errors->first('pincode', '<p style="color: red" class="help-block">:message</p>') !!}
                        </div>
                        <div class="form-group label-floating">
                            <label class="control-label">City</label>
                            <input class="form-control" maxlength="50" id="city" type="text" value="{{ old('city')}}" name="city">
