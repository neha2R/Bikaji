...
@section('content')
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    @endif
    <div class="text-right" style="margin-bottom:10px;"><button  type="button" class="btn btn-primary " data-bs-toggle="collapse" data-bs-target="#demo">Expand Forms</button></div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="row">
                                        <div class="col-sm-3">
  <input class="form-control" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="vh" />
  <h1 style="background-color:#ff0000;font-size:17px;width: 48%;">Very High</h1>
</div>

<div class="col-sm-3">
  <input class="form-control" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="hi" />
  <h1 style="background-color:#ffc100;font-size:17px;width: 25%;">High</h1>
</div>

<div class="col-sm-3">
  <input class="form-control" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="me"  />
  <h1 style="background-color:#ffff00;font-size:17px;width: 42%;">Medium</h1>
</div>

<div class="col-sm-3">
  <input class="form-control" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="lo"  />
...
if($("input[name='fromdate']").val()!='' || $("input[name='cmptype']").val()!='' ||  $("input[name='cmpsource']").val()!=''
   ...
   //// $('#date-filter').get(0).reset();
    ...
    window.location.href = "https://care.bikaji.com/frontoffice/dashboard#section1";
    }
}
        </script>
