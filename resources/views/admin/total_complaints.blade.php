...
<script src="{{URL::asset('files\assets\js\tabpanel-custom.js')}}"></script>
 <div class="row" style="margin-bottom: 10px;">
    <div class="col-md-2">
        <a href="{{route('totalcomplaints')}}" class="btn btn-primary">Remove Filters</a>
    </div>
                ...
                <div class="dt-responsive table-responsive">
                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap complainttable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>{{$i}}</th>
                                <th> {{optional($item->complaint)->uuid ?? 'N/A'}}</th>
                                <th>
                                    <label
                                ...
                                {{-- <td>{{$item->complaint->complaintsource ?? 'N/A'}}</td> --}}
                                <th>
                                    <div class="animation-model">
                                        <button type="button"
                                            ...
                                            @if (optional($item->complaint)->image!='N/A')
                            ...
                            <tr>
                                ...
                                <th>
                                    <div class="animation-model">
                                        <button type="button"
                                            ...
                                            data-img='<img src="{{\Storage::disk('public')->url($item1->image)}}" style="max-width: 300px;max-height: 200px;"/>'
                                ...
                                <td>
                                    @if (checkifresolved($item1->id))
                                        Resolved
                                    @else
                                    <button type="button" class="btn btn-primary waves-effect complaintresolvebtn"
                                    data-id="{{$item1->id}}" data-fromuser="{{$item1->createdby}}"
                                    data-departmentid="{{$item1->complainttype}}" data-toggle="modal"
                                    data-target="#resolve-Modal">
                                        Resolve
                                    </button>
                                    @endif
...
<div class="modal fade" id="resolve-Modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" action="{{ route('resolvecomplaintadmin') }}">
                @csrf
                <div class="modal-header">
